...
namespace Math
{
    public partial class MainF : Form
    {
        ...
        public MainF()
        {
            ...
            ChiDan = new ToolTip();
            ChiDan.SetToolTip(Chuyen, "Bộ chuyển đổi");
            ChiDan.SetToolTip(Pt_Btn, "Phương trình");
            ChiDan.SetToolTip(Hinh_Btn, "Hình học");
            ChiDan.SetToolTip(Dem, "Bộ đếm giờ");
            ChiDan.SetToolTip(Quit, "Thoát");
            ChiDan.SetToolTip(FB_Btn, "Liên hệ");
