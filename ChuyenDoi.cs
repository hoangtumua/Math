...
namespace Math
{
    public partial class Units : Form
    {
        ...
        public Units()
        {
            ...
            ChiDan = new ToolTip();
            ChiDan.SetToolTip(comboBox1, "Đầu vào");
            ChiDan.SetToolTip(comboBox2, "Đầu ra");
            ChiDan.SetToolTip(ChuyenDoi, "Chuyển");
            ChiDan.SetToolTip(Ref, "Làm mới ");
            ChiDan.SetToolTip(Back_Btn, "Trở về");   
            ChiDan.SetToolTip(Quit, "Thoát");
            ChiDan.SetToolTip(DaoNguoc, "Đảo ngược");
        }
        ...
        private void ChuyenDoi_Click(object sender, EventArgs e)
        {
            ...
            txtInput.Text = string.IsNullOrEmpty(txtInput.Text) ? "0" : txtInput.Text;
            ...
            if (double.TryParse(txtInput.Text, out double input))
            {
                ...
                txtResult.Text = System.Math.Round(result, 6).ToString();
            }
            else
            {
        ...
        private double ChuyenDoiDonVi(double value, string fromUnit, string toUnit)
        {
            ...
            else if (Type.SelectedItem.ToString() == "Nhiệt độ")
            {
                ...
                switch (fromUnit)
                {
                    ...
                    case "°F": tempInCelsius = (value - 32) / 1.8; break;
                    case "°K": tempInCelsius = value - 273.15; break;
                }
                switch (toUnit)
                {
                    case "°C": return tempInCelsius;
                    case "°F": return tempInCelsius * 9 / 5 + 32;
                    case "°K": return tempInCelsius + 273.15;
                }
            }
        ...
        private void Type_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (Type.SelectedItem.ToString() == "Nhiệt độ")
            {
                comboBox1.Items.Clear();
                comboBox2.Items.Clear();
                comboBox1.Items.AddRange(new string[] { "°C", "°F", "°K" });
                comboBox2.Items.AddRange(new string[] { "°C", "°F", "°K" });
